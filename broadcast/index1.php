...
<html lang="en">
<head>
	<title>Zain ACS Broadcast</title>
	<meta charset="UTF-8">
...
$a++;
		echo("<p style='font-size:100%;' onclick='Send(\"".$row['appid']."\")'> ".$row['appid']."</p>");
...
?>
				...
				<div class="container-contact100-form-btn">
					<div class="wrap-contact100-form-btn">
						...
						<button class="contact100-form-btn" onclick='Send("")'>
							<span>
								Submit
...
//alert(d);
		...
		var Tocken = document.getElementById("receiver").innerHTML;
		document.getElementById("receiver").innerHTML = a;
		...
		var jqxhr = $.post( "https://exp.host/--/api/v2/push/send",  
							{
									...
									"badge":2,
									"sound":"default",
									"data": { "title":service,"message": msg}
